...
PDF_FORMAT   = os.environ.get("PDF_FORMAT",   "A4")            # A4 or Letter, etc.
...
def lambda_handler(event, context=None):
    ...
    # also copy HTML to dest for inspection
    s3.copy_object(
    ...
    # render with Chromium (like Ctrl+P)
    with sync_playwright() as p:
        ...
        try:
            ...
            pdf_bytes = page.pdf(
                format=PDF_FORMAT,            # honored only if CSS @page size not set
